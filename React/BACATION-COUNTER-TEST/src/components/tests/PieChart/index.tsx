...
// // New pie chart data and color scales
// const newPieData = [
//   { label: 'New A', value: 40 },
//   { label: 'New B', value: 30 },
//   { label: 'New C', value: 20 },
//   { label: 'New D', value: 10 },
// ];
// const getNewPieColor = scaleOrdinal({
//   domain: newPieData.map((d) => d.label),
...
//               getKey={(arc) => arc.data.label}
//               onClickDatum={({ data: { label } }) =>
//                 animate && console.log(`Clicked new pie segment: ${label}`)
//               }
//               getColor={(arc) => getNewPieColor(arc.data.label)}
//             />
//           )}
//         </Pie>
//       </Group>
